...
@Model.describe(
    slug='contrib.dhg-generalized-cashflow',
    version='1.1',
    display_name='Generalized Cashflow',
    description='A generalized model that tracks all one-directional cashflow from a sender address to a receiver address.',
    input=GCInput,
    output=dict
)
