...
class ExampleAddress(credmark.model.Model):
    def run(self, input) -> dict:
        ...
        contract = Contract(address='0x2F50D538606Fa9EDD2B11E2446BEb18C9D5846bB') # curve.fi gauge controller

        self.logger.info(
            f"Contract is a subclass of Account, and is itialized with an address.")
        self.logger.info(
