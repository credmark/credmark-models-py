...
class ExampleAddress(Model):
    def run(self, input) -> dict:
        ...
        return {"message": "see https://github.com/credmark/credmark-models-py/blob/main/models/examples/contract_examples.py for examples of Contract usage"}  # pylint: disable=line-too-long
