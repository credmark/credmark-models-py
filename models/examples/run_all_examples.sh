...
echo "ECHO Example:"
echo ""
credmark-dev run example-echo --input '{"message":"hello world"}'
echo ""
...
credmark-dev run example-load-contract-by-address --input '{"address": "0xa8f8dd56e2352e726b51738889ef6ee938cca7b6"}' --api_url=http://localhost:7000/v1/models/run -b 14234904
echo ""
...
echo ""
credmark-dev run example-30-day-series --input '{"slug":"example-echo", "input":{"message":"hello world"}}' --api_url=http://localhost:7000/v1/models/run -b 14234904
