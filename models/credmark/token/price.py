...
@credmark.model(slug='uniswap-router-price-usd',
                version='1.0',
...
@credmark.model(slug='uniswap-router-price-pair',
                version='1.0',
...
@credmark.model(slug='uniswap-tokens',
                version='1.0',
...
@credmark.model(slug='uniswap-exchange',
                version='1.0',
