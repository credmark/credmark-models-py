...
class xCmkCmkStaked(credmark.model.Model):  # pylint: disable=invalid-name
    ...
    def run(self, input) -> dict:
        ...
        cmk_contract = Contract(address=Address(CREDMARK_ADDRESS).checksum,
                                abi=CREDMARK_ABI)
