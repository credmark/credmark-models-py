...
class SushiSwapPool(Contract):
    class Config:
        schema_extra = {"examples": [{"address": "0x6a091a3406E0073C3CD6340122143009aDac0EDa"}]}
...
class SushiSwapDexPoolPriceInput(SushiSwapPool, DexPoolPriceInput):
    class Config:
        schema_extra = {
            "examples": [
                {
                    "address": "0x6a091a3406E0073C3CD6340122143009aDac0EDa",  # ILV-WETH
...
@Model.describe(
    slug="sushiswap.get-pool-by-pair",
    version=SUSHISWAPV3_VERSION,
...
@Model.describe(
    slug="sushiswap.all-pools-events",
    version=SUSHISWAPV3_VERSION,
...
@Model.describe(
    slug="sushiswap.all-pools-ledger",
    version=SUSHISWAPV3_VERSION,
...
@Model.describe(
    slug="sushiswap.get-pools-ledger",
    version=SUSHISWAPV3_VERSION,
    display_name="SushiSwap Token Pools",
...
@Model.describe(
    slug="sushiswap.get-pools-tokens",
    version=SUSHISWAPV3_VERSION,
...
@Model.describe(
    slug="sushiswap.get-ring0-ref-price",
    version=SUSHISWAPV3_VERSION,
...
@Model.describe(
    slug="sushiswap.get-pool-info-token-price",
    version=SUSHISWAPV3_VERSION,
    display_name="SushiSwap Token Pools",
...
class SushiSwapGetTokenPriceInfo(UniswapV2PoolMeta, SushiSwapFactoryMeta):
    def run(self, input: DexPriceTokenInput) -> Some[PoolPriceInfo]:
        pools = self.context.run_model("sushiswap.get-pools", input, return_type=Contracts)
