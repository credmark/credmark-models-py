...
class PancakeSwapV3FactoryMeta:
    FACTORY_ADDRESS = {
        ...
        for k in [Network.BSC, Network.Mainnet]
    }
...
class PancakeSwapV3Pool(Contract):
    class Config:
        schema_extra = {"examples": [{"address": "0x6E229C972d9F69c15Bdc7B07f385D2025225E72b"}]}
...
class PancakeSwapV3DexPoolPriceInput(PancakeSwapV3Pool, DexPoolPriceInput):
    class Config:
        schema_extra = {
            "examples": [
                {
                    "address": "0x6E229C972d9F69c15Bdc7B07f385D2025225E72b",  # MASK / USDC
...
@Model.describe(
    slug="pancakeswap-v3.get-factory",
...
@Model.describe(
    slug="pancakeswap-v3.get-pools-by-pair",
    version=PANCAKESWAP_V3_VERSION,
...
@Model.describe(
    slug="pancakeswap-v3.all-pools-events",
    version=PANCAKESWAP_V3_VERSION,
...
@Model.describe(
    slug="pancakeswap-v3.all-pools-ledger",
    version=PANCAKESWAP_V3_VERSION,
...
@Model.describe(
    slug="pancakeswap-v3.get-pools-ledger",
    version=PANCAKESWAP_V3_VERSION,
    display_name="PancakeSwap v3 Token Pools",
...
@Model.describe(
    slug="pancakeswap-v3.get-pools-tokens",
    version=PANCAKESWAP_V3_VERSION,
    display_name="PancakeSwap v3 Token Pools",
    description="The PancakeSwap v3 pools that support a token contract",
    category="protocol",
...
@Model.describe(
    slug="pancakeswap-v3.get-ring0-ref-price",
    version=PANCAKESWAP_V3_VERSION,
...
@Model.describe(
    slug="pancakeswap-v3.get-pool-info-token-price",
    version=PANCAKESWAP_V3_VERSION,
...
class PancakeSwapV3GetTokenPoolInfo(UniswapV3PoolMeta, PancakeSwapV3FactoryMeta):
    def run(self, input: DexPriceTokenInput) -> Some[PoolPriceInfo]:
        pools = self.context.run_model("pancakeswap-v3.get-pools", input, return_type=Contracts)
