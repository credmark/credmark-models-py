...
class TestPolygon(CMFTest):
    def test(self):
        ...
        last_block_output = self.run_model('chain.get-latest-block', {}, block_number=None, chain_id=137)

        last_block = last_block_output['output']['blockNumber']

        self.run_model('price.oracle-chainlink',
                       {"base": "0x1ba42e5193dfa8b03d15dd1b86a3113bbbef8eeb"}, block_number=last_block-100, chain_id=137)
