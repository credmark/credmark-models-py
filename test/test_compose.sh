test_model 0 compose.map-block-time-series '{"modelSlug":"chainlink.price-usd", "modelInput":{"address": "0xD533a949740bb3306d119CC777fa900bA034cd52"}, "endTimestamp": "1645446694", "interval": "86400", "count":"3", "exclusive": "True"}'
