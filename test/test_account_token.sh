...
test_model 0 price.cmf '{"symbol": "WETH"}' ${token_price_deps}
test_model 0 price.cmf '{"symbol": "CMK"}' ${token_price_deps}
test_model 0 price.cmf '{"symbol": "AAVE"}' ${token_price_deps}
# AAVE: 0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9
test_model 0 price.cmf '{"address": "0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9"}' ${token_price_deps}
test_model 0 price.cmf '{"symbol": "USDC"}' ${token_price_deps}
test_model 0 price.cmf '{"symbol": "MKR"}' ${token_price_deps}
# Ampleforth: 0xd46ba6d942050d489dbd938a2c909a5d5039a161
test_model 0 price.cmf '{"address": "0xd46ba6d942050d489dbd938a2c909a5d5039a161"}' ${token_price_deps}
# RenFil token: 0xD5147bc8e386d91Cc5DBE72099DAC6C9b99276F5
test_model 0 price.cmf '{"address": "0xD5147bc8e386d91Cc5DBE72099DAC6C9b99276F5"}' ${token_price_deps}
