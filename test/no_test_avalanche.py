...
class TestAvalanche(CMFTest):
    def test(self):
        ...
        # Curve 2 for avUSDC
        # credmark-dev run aave-v2.account-info-reserve -i '{"address": "0x7f90122BF0700F9E7e1F688fe926940E8839F353", "reserve": "0x46A51127C3ce23fb7AB1DE06226147F446e4a857"}' -b 32537910 -c 43114 -j
        self.run_model(
            'aave-v2.account-info-reserve',
            {"address": "0x7f90122BF0700F9E7e1F688fe926940E8839F353",
                "reserve": "0x46A51127C3ce23fb7AB1DE06226147F446e4a857"},
            chain_id=chain_id,
            block_number=32537910)
