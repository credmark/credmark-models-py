...
echo ""
credmark-dev run compound-v2.get-pool-info --input '{"address":"0x95b4ef2869ebd94beb4eee400a99824bf5dc325b"}' -l ,compound-v2.get-comptroller -b 14234904 --format_json
...
credmark-dev run compound-v2.all-pools-info --input '{}' -l compound-v2.get-pool-info,compound-v2.get-pools, -b 14234904 --format_json
credmark-dev run compound-v2.pool-value-historical --input '{"date_range": ["2021-12-15", "2021-12-18"], "token": {"address":"0x70e36f6bf80a52b3b46b3af8e106cc0ed743e8e4"}}' -l ,compound-v2.get-comptroller,compound-v2.get-pool-info,compound-v2.pool-value -b 14234904 --format_json
credmark-dev run compound-v2.pool-value-historical --input '{"date_range": ["2021-09-15", "2021-09-20"], "token": {"address":"0x70e36f6bf80a52b3b46b3af8e106cc0ed743e8e4"}}' -l ,compound-v2.get-comptroller,compound-v2.get-pool-info,compound-v2.pool-value -b 14234904 --format_json
credmark-dev run compound-v2.pool-value-historical --input '{"date_range": ["2022-01-15", "2022-01-18"], "token": {"address":"0x70e36f6bf80a52b3b46b3af8e106cc0ed743e8e4"}}' -l ,compound-v2.get-comptroller,compound-v2.get-pool-info,compound-v2.pool-value -b 14234904 --format_json
echo ""
