...
test_model 0 price.cmf '{"symbol":"AAVE"}'
test_model 0 price.cmf '{"symbol":"WETH"}'
test_model 0 price.cmf '{"symbol":"WBTC"}'
test_model 0 price.cmf '{"address":"0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE"}'
test_model 0 price.cmf '{"address":"0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB"}'
test_model 0 price.cmf '{"address":"0xD31a59c85aE9D8edEFeC411D448f90841571b89c"}'
