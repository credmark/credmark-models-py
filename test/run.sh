...
${cmk_dev} list | awk -v script_dir=$SCRIPT_DIRECTORY -v test_scripts=examples,account_token,cmk,aave,compound,uniswap,sushiswap,curve,finance,tvl,price 'BEGIN {
